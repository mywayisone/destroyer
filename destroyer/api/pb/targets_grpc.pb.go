...
type DestroyerClient interface {
	...
	AcquireTargets(ctx context.Context, in *TargetsRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// RPC method that lists targets acquired from the database
	ListTargets(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*TargetsResponse, error)
}
...
func (c *destroyerClient) AcquireTargets(ctx context.Context, in *TargetsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *destroyerClient) ListTargets(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*TargetsResponse, error) {
...
type DestroyerServer interface {
	// RPC method that acquires targets
	AcquireTargets(context.Context, *TargetsRequest) (*empty.Empty, error)
	// RPC method that lists targets acquired from the database
	ListTargets(context.Context, *empty.Empty) (*TargetsResponse, error)
...
func (UnimplementedDestroyerServer) AcquireTargets(context.Context, *TargetsRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AcquireTargets not implemented")
}
func (UnimplementedDestroyerServer) ListTargets(context.Context, *empty.Empty) (*TargetsResponse, error) {
...
func _Destroyer_ListTargets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DestroyerServer).ListTargets(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
